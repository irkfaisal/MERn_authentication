...
const Registration = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (actualData.name && actualData.email && actualData.password && actualData.password_conf && actualData.tc !== null) {
            if (actualData.password === actualData.password_conf) {
                ...
                if (res.data.status === "success") {
                    ...
                    setError({ status: true, msg: "Registration failed", type: 'error' })
                }
            } else {
